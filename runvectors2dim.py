...
if numop == 1:
    ...
    print('\n\t**[WILL FIND THE [VALUE] OF THE [THETA ANGLE]')
    print('\t  BETWEEN [TWO VECTORS] GIVEN: A AND B]**\n')
    ...
    print('\n\t**[TO FIND THE [ADDITION AND SUBTRACTION] OF [TWO VECTORS:')
    print(' A and B] IN THE BI-DIMENSIONAL(XY) PLANE]**\n')
