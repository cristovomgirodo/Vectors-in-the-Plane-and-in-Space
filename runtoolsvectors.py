...
# Date: 20220703 -- Stable Version: 1.2
#
...
print('  and R key [8]\n')
print('- To find the [Area] and [Height] of the [Parallelogram] givens [two vectors]:')
print('  A and B key [9]\n')
...
if numb == 1:
    ...
    print('\t**[ FIND THE AREA(A) AND HEIGHT(H) PARALLELOGRAM GIVEN THE VECTORS:')
    print('\t  A AND B ]**\n')
    varint = 4
