...
def introduce():
    while True:
        try:
            ...
            print('\t**[ [The typed number]:',coeffic1,'is a [valid integer or float number!] ]**\n')
            return coeffic1
        except ValueError as err:
            print('\t    /////')
            print('\t    º<º [Warning!]:',err)
            print('\t    \~/ [ TYPE AN NEW POSITIVE INTEGER OR FLOAT NUMBER ]')
            print('\t        [ IN NEXT INSTRUCTION -- OK! ]\n')
...
def formaComponent():
    ...
    answer()
    print('\t+ The vectorAcoeffic1',vectorAcoeffic1)
    print('\t+ The vectorBcoeffic2',vectorBcoeffic2,'\n')
    Addition = []
    Subtraction = []
    ...
    print('\t-- The vectorAddition', Addition)
    print('\t-- The vectorSubtraction', Subtraction,'\n')
...
def directionAngles():
    ...
    if number == 1:
        ...
        answer() # was insert the function answer()
